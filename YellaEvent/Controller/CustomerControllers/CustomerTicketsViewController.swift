...
//        Task{
//           try await TicketsManager.createNewTicket(ticket: Ticket(ticketID: "ticket", eventID: "event1", userID: "1", didAttend: false, price: 12.12))
//            
//            
//        }
//        Task{
//            self.tickets = try await  TicketsManager.getUserTickets(userId: "1")
